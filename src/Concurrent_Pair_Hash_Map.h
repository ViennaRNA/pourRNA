...
public:
  ...
  typename
  std::unordered_map<T,U,V,W>::iterator find ( T& k ){
   std::unique_lock<std::mutex> mlock(mutex_);
  ...
  typename
  std::unordered_map<T,U,V,W>::iterator begin() noexcept{
    std::unique_lock<std::mutex> mlock(mutex_);
  ...
  typename
  std::unordered_map<T,U,V,W>::iterator end() noexcept{
    std::unique_lock<std::mutex> mlock(mutex_);
 ...
 typename
 std::unordered_map<T,U,V,W>& operator= (const std::unordered_map<T,U,V,W>& ump ){
   return ump;
 }
